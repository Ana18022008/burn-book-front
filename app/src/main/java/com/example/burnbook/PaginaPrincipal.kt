...
fun PaginaPrincipal(navController: NavController, viewModel: FeedViewModel) {
    ...
    val deveCarregarMais by remember {
        derivedStateOf {
            ...
            ultimoVisivel >= totalItens - 3
        }
    }

    LaunchedEffect(deveCarregarMais) {
        if (deveCarregarMais) viewModel.carregarMais()
    }
    ...
    Surface(
        ...
        Row(
            ...
            Box(
                modifier = Modifier
                    .size(40.dp)
                    .clickable { navController.navigate("postsUser") }
            ) {
                Icon(
                    ...
                    IconButton(
                        ...
                        Icon(
                            painter = painterResource(
                                id = if (publicacao.curtidoPorMim) R.drawable.icone_gostei
                                else R.drawable.icone_gostei
                            ),
